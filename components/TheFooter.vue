<template>
  <footer class="container mx-auto mt-auto text-sm border-t border-gray-300 py-10 flex items-center justify-between">
    ...
    <a href="#">
      <svg aria-hidden="true" viewBox="0 0 16 16" class="w-6 fill-current text-gray-400 hover:text-gray-600">
