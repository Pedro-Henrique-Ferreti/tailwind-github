<template>
  <div class="w-1/4">
    <sidebar-item title="About">
      ...
      <p class="mt-4 italic text-gray-600">No description, website, or topics provided.</p>
    </sidebar-item>
    <sidebar-item title="Releases">
      <p class="mt-4 text-xs text-gray-600">No releases published</p>
      <a href="#" class="text-xs text-blue-600 hover:underline">Create a new release</a>
    </sidebar-item>
    <sidebar-item title="Packages">
